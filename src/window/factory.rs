...
use crate::{
    platform::prelude::{MonitorExt, WindowExt, calculate_window_center_position},
    types::{FocusState, WebContextStore, WebviewUrl},
    utils::{RawWindow, WindowWebViewMetaData, find_monitor_for_position},
    webview::WebViewId,
        ...
        + 'static,
{
    ...
    Ok(ManagedWindow {
        ...
        focused_webview,
        close_requested_handler,
        menu: Arc::new(Mutex::new(menu)), // ← fertig
    })
}
